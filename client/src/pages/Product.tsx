      ...
      <div className='flex flex-col md:flex-row gap-6'>
        ...
        <div className='flex flex-col w-full md:w-1/2 bg-gray-100 rounded-2xl p-6 gap-4'>
          ...
          <div className='flex items-center justify-between mt-auto'>
            ...
            {/* ADD BUTTON */}
            <button onClick={() => addToCart(productData.id)} className='bg-red-500 text-white px-4 py-2 rounded-xl hover:bg-red-400 transition flex justify-between items-center gap-3'>
              <span>В корзину</span>
