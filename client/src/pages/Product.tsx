  ...
  return (
    <div className='flex flex-col gap-5 mx-4 md:mx-10 my-6'>
      ...
      <div className='flex flex-col md:flex-row gap-6'>
        ...
        <div className='flex flex-col w-full md:h-1/2 md:w-1/2 bg-gray-100 rounded-2xl p-6 gap-4'>
          ...
          <div className='flex items-center justify-between mt-auto md:mt-10'>
