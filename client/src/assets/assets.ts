...
import dot_white from './dot-white.svg'
import vk from './vk.svg'
import dot_red from './dot-red.svg'
import menu from './menu1.jpg'
import logo from './logo.webp'
import location from './location.svg'
import simbol from './simbol.svg'
import circle_plus from './circle_plus.svg'
import circle_minus from './circle_minus.svg'
import cross_icon from './cross_icon.svg'

export const assets = {location, dot_white, vk, dot_red, menu, logo, simbol, circle_minus, circle_plus, cross_icon}
